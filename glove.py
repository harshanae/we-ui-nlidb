...
def run_glove_server(trained_model_path):
    # load Glove's pre-trained model
    model = gensim.models.KeyedVectors.load_word2vec_format(trained_model_path, binary=False, no_header=True)
...
if __name__ == '__main__':
    glove_model="model/glove.840B.300d.txt"
    run_glove_server(trained_model_path = glove_model)
